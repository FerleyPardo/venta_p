        ...
        <div class="carousel-inner">
                ...
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./assets/img/prom_03.png" alt="">
                        </div>
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./assets/img/bici.png" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
            ...
            <div class="carousel-item">
                <div class="container">
                    <div class="row p-5">
                        <div class="mx-auto col-md-8 col-lg-6 order-lg-last">
                            <img class="img-fluid" src="./assets/img/bici3.png" alt="">
                        </div>
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left">
                                <h1 class="h1"></h1>
    ...
    <section class="container py-5">
        ...
        <div class="row">
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/img/Bicicleta-Naranja.jpg" class="rounded-circle img-fluid border"></a>
                <h5 class="text-center mt-3 mb-3">BICICLETAS</h5>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/img/ROPA_D.jpg" class="rounded-circle img-fluid border"></a>
                <h2 class="h5 text-center mt-3 mb-3">ROPA DEPORTIVA</h2>
                <p class="text-center"><a class="btn btn-success">Go Shop</a></p>
            </div>
            <div class="col-12 col-md-4 p-5 mt-3">
                <a href="#"><img src="./assets/img/accesorios_venta.png" class="rounded-circle img-fluid border"></a>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.php">
                            <img src="./assets/img/prom_1.jpg" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <li class="text-muted text-right">$2.400.000</li>
                            </ul>
                            <a href="shop-single.php" class="h2 text-decoration-none text-dark">FX 1 Disc M Satin Trek Black</a>
                            <p class="card-text">
                                Esta bicicleta une a las familias y les permite disfrutar de la naturaleza; 
                                Frenar con confianza significa poder disfrutar incluso cuando el tiempo no acompaña;
                                Es tan versátil que está preparada para todo lo que se te ocurra.
                            </p>
                ...
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.php">
                            <img src="./assets/img/bici3.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                                ...
                                <li class="text-muted text-right">$4.799.900</li>
                            </ul>
                            <a href="shop-single.php" class="h2 text-decoration-none text-dark"> GW SNAKE RIN 29″ CARBONO GRUPO SHIMANO 11 VEL</a>
                            <p class="card-text">
                                Marco 29 GW Snake En Carbono GW SUSPENSIÓN SUNTOUR
                                 XCM BLOQUEO REMOTO GRUPO SHIMANO DEORE 11 VELOCIDADES MONOPLATO SHIMANO FC M5100-32T.
                            </p>
                ...
                <div class="col-12 col-md-4 mb-5">
                    <div class="card h-100">
                        <a href="shop-single.php">
                            <img src="./assets/img/prom_03.png" class="card-img-top" alt="...">
                        </a>
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                <li>
                                ...
                                <li class="text-muted text-right">$3.375.000</li>
                            </ul>
                            <a href="shop-single.php" class="h2 text-decoration-none text-dark">SCOTT ASPECT 940 GRANITE</a>
                            <p class="card-text">
                                Características Principales

                                Cuadro de aleación Aspect 700/900
                                Suntour XCR32-LO-R 100 mm
                                Shimano Alivio, 18 velocidades
                                Frenos Shimano
                                Kenda Booster
                            </p>
